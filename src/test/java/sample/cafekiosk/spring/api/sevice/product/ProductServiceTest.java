package sample.cafekiosk.spring.api.sevice.product;
...
class ProductServiceTest {
    ...
    @Test
    @DisplayName("신규 상품을 등록한다. 상품번호는 가장 최근 상품의 상품번호에서 +1 한 값이다.")
    void createProduct() {
        // given
    ...
    @Test
    @DisplayName("신규 상품을 등록할 때 상품이 하나도 없는 경우 product_number는 001이다.")
    void createProduct_whenProductIsEmpty() {
        // given
        ProductCreateServiceRequest request = ProductCreateServiceRequest.builder()
                .type(HANDMADE)
                .sellingStatus(SELLING)
