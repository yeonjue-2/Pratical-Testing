...
import sample.cafekiosk.spring.api.sevice.order.request.OrderCreateServiceRequest;
...
public class OrderService {
    ...
    private void deductStockQuantity(List<Product> products) {
        ...
        Map<String, Long> productCountingMap = createCountingMapBy(stockProductNumbers);  // 상품별 counting
